...
class Filter_Price(models.Model):
    FILTER_PRICE = (
        ...
        ('200000 TO 300000', '200000 TO 300000'),
        ('300000 TO 400000', '300000 TO 400000'),
        ('400000 TO 500000', '400000 TO 500000'),
        ('>500000' , '>500000')
    )
...
class Product(models.Model):
    ...
    created_date = models.DateTimeField(default=timezone.now, max_length=200)
